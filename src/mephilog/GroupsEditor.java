 ...
 * @author vlad
 */
public class GroupsEditor extends javax.swing.JFrame {
    ...
    private void UpdateTable() {
        ...
        String queryStr = "select id,name, count(student_id) as num from groups left outer join (select distinct group_id,student_id from scores) t on groups.id = t.group_id\n"
                + "group by id";
    ...
    private void initComponents() {
        ...
        GroupsTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ИД в базе", "Группа", "Число студентов"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String groupName = JOptionPane.showInputDialog("Введите название новой группы");
        if (!groupName.isEmpty()) {
            String queryStr = "INSERT INTO groups set name = '"+MephiLog.db.quoteString(groupName) +"'";   
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        int rowNum = GroupsTable.getSelectedRow();
        String id = GroupsTable.getValueAt(rowNum, 0).toString();
        if (!id.isEmpty()) {
            String queryStr = "DELETE FROM groups WHERE id = '"+MephiLog.db.quoteString(id) +"'";   
            int rs = MephiLog.db.updateQuery(queryStr);
        }
        this.UpdateTable();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GroupsEditor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
